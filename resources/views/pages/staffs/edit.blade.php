        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold mb-4 text-gray-800">Edit Staff</h3>

                    <form action="{{ route('users.update', $staff) }}" method="POST" class="space-y-4"
                        ...
                        <div class="flex flex-col md:flex-row md:gap-4">
                            ...
                            <div class="mb-2 md:mb-0 md:flex-1">
                                ...
                                <input type="text" id="role_display" name="role_display"
                                    value="{{ $staff->role == 'R01' ? 'Admin (R01)' : 'Staff (R02)' }}"
